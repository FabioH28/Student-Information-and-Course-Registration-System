...
from src.utils.security import canonical_role, verify_password, hash_password, create_access_token, get_current_user
...
def _display_name(user: User, db: Session) -> str:
    ...
    elif canonical_role(user.role) == "instructor":
