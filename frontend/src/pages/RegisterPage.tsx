    ...
    <div className="min-h-screen flex bg-background">
      <div className="relative hidden overflow-hidden gradient-primary p-12 lg:flex lg:w-1/2 lg:items-center lg:justify-center">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
          ...
          <h1 className="mb-4 text-4xl font-bold text-primary-foreground">Join CIS</h1>
          <p className="text-lg leading-relaxed text-primary-foreground/80">
            Request access to the CIS portal. Once you verify your email, an administrator will review and activate your account.
          </p>
        </motion.div>
      </div>
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, delay: 0.2 }}
          ...
          <form onSubmit={submit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Alice Smith" className="h-11"
                value={fullName} onChange={e => setFullName(e.target.value)} required />
            </div>
            <div className="space-y-2">
              <Label htmlFor="email">Email</Label>
              <Input id="email" type="email" placeholder="your@cis.edu" className="h-11"
