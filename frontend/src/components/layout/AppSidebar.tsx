...
import {
  ...
  CheckSquare, FileText, CreditCard, ShieldAlert,
  Newspaper, Trophy, Inbox, Megaphone, KeyRound
} from "lucide-react";
...
const studentNav: NavItem[] = [
  ...
  { title: "Available Subjects", icon: BookOpen, path: "/student/available-subjects" },
  { title: "Selected Subjects", icon: ClipboardList, path: "/student/course-selections" },
  { title: "Timetable", icon: CalendarDays, path: "/student/timetable" },
  { title: "Materials", icon: FileText, path: "/student/materials" },
  { title: "Assignments", icon: ClipboardList, path: "/student/assignments" },
  { title: "Attendance", icon: CheckSquare, path: "/student/attendance" },
  { title: "Grades", icon: GraduationCap, path: "/student/grades" },
  { title: "News", icon: Newspaper, path: "/student/news" },
  { title: "Clubs", icon: Trophy, path: "/student/clubs" },
  { title: "Inbox", icon: Inbox, path: "/student/inbox" },
  { title: "Risk Warning", icon: AlertTriangle, path: "/student/risk" },
  { title: "AI Chatbot", icon: Bot, path: "/student/chatbot" },
  { title: "Change Password", icon: KeyRound, path: "/student/change-password" },
];
...
const adminNav: NavItem[] = [
  ...
  { title: "Change Password", icon: KeyRound, path: "/admin/change-password" },
];
...
const instructorNav: NavItem[] = [
  ...
  { title: "Materials", icon: FileText, path: "/instructor/materials" },
  { title: "Assignments", icon: ClipboardList, path: "/instructor/assignments" },
...
const academicStaffNav: NavItem[] = [
  ...
  { title: "Profile", icon: User, path: "/academic-staff/profile" },
  ...
  { title: "Staff Offerings", icon: BookOpen, path: "/academic-staff/staff-course-offerings" },
  { title: "Manage Offerings", icon: BookOpen, path: "/academic-staff/offerings" },
...
const staffNav: NavItem[] = [
  ...
  { title: "Profile", icon: User, path: "/staff/profile" },
  { title: "Course Offerings", icon: BookOpen, path: "/staff/course-offerings" },
  { title: "Manage Offerings", icon: BookOpen, path: "/staff/manage-offerings" },
  { title: "Timetable", icon: CalendarDays, path: "/staff/timetable" },
  { title: "Buildings & Rooms", icon: Calendar, path: "/staff/buildings-rooms" },
  { title: "Course Catalog", icon: BookOpen, path: "/staff/courses" },
  { title: "Registrations", icon: ClipboardList, path: "/staff/registrations" },
...
const financeStaffNav: NavItem[] = [
  ...
  { title: "Profile", icon: User, path: "/finance-staff/profile" },
  { title: "Student Accounts", icon: Users, path: "/finance-staff/students" },
  ...
  { title: "Change Password", icon: KeyRound, path: "/finance-staff/change-password" },
];
...
interface AppSidebarProps {
  role: "student" | "admin" | "instructor" | "academic-staff" | "staff" | "finance-staff";
  collapsed: boolean;
  onToggle: () => void;
  mobileOpen?: boolean;
  onMobileClose?: () => void;
            ...
            >
              <div className="flex h-16 items-center justify-between border-b border-border px-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-lg whitespace-nowrap">CIS</span>
                </div>
                <button
                  type="button"
                  onClick={onMobileClose}
