-- Combined clean CIS database SQL for GitHub/XAMPP handoff
-- Generated from backend/database/mysql project scripts.
-- Import into MySQL/MariaDB or phpMyAdmin to recreate the cis database.


-- ============================================================================
-- Source: backend\database\mysql\01_schema.sql
-- ============================================================================
